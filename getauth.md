...
As we evolve our query to modify user data–expanding our grant_type and adding redirect URLs to our Auth flows–we'll be adding new queries and steps, but we'll largely be relying on these same @materializer and @sequence directives to handle them.
